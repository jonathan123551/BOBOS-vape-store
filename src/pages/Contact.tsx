    ...
    <div className="container-page py-10">
      <div className="max-w-3xl mx-auto space-y-8 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          >
            <div className="h-14 w-14 grid place-items-center rounded-full bg-brand-700/30 text-2xl">
              📞
            </div>
            ...
            <span className="btn-primary mt-1 group-hover:shadow-neon-purple">
          ...
          <a
            ...
            className="card neon-border p-8 group hover:-translate-y-0.5 transition flex flex-col items-center gap-3"
          >
            <div className="h-14 w-14 grid place-items-center rounded-full bg-emerald-600/30 text-2xl">
              💬
            </div>
